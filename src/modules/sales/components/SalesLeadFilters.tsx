...
export function hasActiveFilters(filters: SalesLeadFilterState): boolean {
...
export function SalesLeadFilters({ filters, onChange, localities }: SalesLeadFiltersProps) {
