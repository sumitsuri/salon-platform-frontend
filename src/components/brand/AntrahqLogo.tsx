  ...
  return (
    <div className={cn("flex items-center gap-3", className)}>
      <div
        className={cn(
          ...
          variant === "light"
            ...
            : "bg-[var(--brand-light)] border border-[var(--brand-muted)]"
        )}
      ...
      <div className="min-w-0">
        <p className={cn("font-bold tracking-tight leading-none", textClass, fg)}>Antrahq</p>
